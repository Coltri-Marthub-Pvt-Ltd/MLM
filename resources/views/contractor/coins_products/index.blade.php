...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0" style="color: var(--contractor-dark); font-weight: 700;">Browse Coins Products</h1>
    ...
    <div class="filter-card">
        <form method="GET" action="{{ route('contractor.coins-products.index') }}">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-2">
                    <a href="{{ route('contractor.coins-products.index') }}" class="btn btn-contractor-outline w-100">
            ...
            @foreach($products as $product)
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    <div class="product-card">
                        <a href="{{ route('contractor.coins-products.show', $product) }}" class="text-decoration-none">
    ...
    @else
        ...
        <div class="contractor-card text-center py-5">
            <div class="contractor-card-content">
                ...
                @if(request()->hasAny(['search', 'category']))
                    <a href="{{ route('contractor.coins-products.index') }}" class="btn btn-contractor">
