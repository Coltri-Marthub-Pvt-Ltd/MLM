            ...
            <div class="contractor-card">
                <div class="contractor-card-content">
                    ...
                    <div class="row mb-4">
                        <div class="col-6">
                            <div class="text-center p-3" style="background: rgba(5, 150, 105, 0.1); border-radius: 8px;">
                                ...
                                <small class="text-muted">Market Price</small>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="text-center p-3" style="background: rgba(243, 179, 116, 0.1); border-radius: 8px;">
                                <h3 class="mb-1" style="color: var(--contractor-primary); font-weight: 700;">
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    <td style="color: #6B7280; font-weight: 500;">Reward Coins:</td>
                                    <td style="color: var(--contractor-primary); font-weight: 600;">
                    ...
                    <div class="d-flex gap-3">
                        <button class="btn btn-contractor-outline" id="orderNowBtn" data-id="{{ $product->id }}">
                            <i class="bi bi-arrow-left me-2"></i>
                            Proceed to Order
                        </button>
                        @if (!$product->cart)
                            <button class="btn btn-contractor" id="addToCartBtn" data-id="{{ $product->id }}">
                                <i class="bi bi-cart-check me-1"></i>
                                Add to Cart
                            </button>
                            @else
                            <a href="{{route('contractor.show.cart')}}" class="btn btn-success" data-id="{{ $product->id }}">
                                <i class="bi bi-cart-check me-1"></i>
                                Go to Cart
                            </a>
                        @endif
                ...
                success: function(response) {
                    if (response.success) {
                       $('#addToCartBtn').replaceWith(`
                        <a href="{{ route('contractor.show.cart') }}" class="btn btn-success" data-id="${response.product_id}">
                            <i class="bi bi-cart-check me-1"></i>
                            Go to Cart
                        </a>
                    `);
