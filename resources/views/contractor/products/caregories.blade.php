        ...
        <div class="row g-3">
            ...
            @foreach ($data as $cat)
                ...
                <div class="col-md-6 col-6">
                    <a href="{{($tableName=='product_types') ? route('contractor.type.brands') : route('contractor.products.brand.product', [$tableName, $cat->id]) }}" class="card-link">
                        <div class="data-card {{ $randomGradient }}">
                            <div class="card-badge">{{ $cat->products->count() }}</div>
                            <div class="card-content d-flex flex-column justify-content-between h-100">
                                <h3 class="card-title text-center mb-2"> {{ $cat->name }}</h3>
