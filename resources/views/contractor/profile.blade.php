                            ...
                            <div class="content-section welcome-content">
                                <div class="welcome-section">
                                    ...
                                    <div class="personal-info">
                                        ...
                                        <p><i class="fas fa-phone"></i> +91 {{ Auth::user()->phone }}</p>
                                    </div>
                                    <div class="quick-stats">
                                        <a href="{{ route('contractor.myorders') }}" style="text-decoration: none;">
                                            <div class="stat-item">
                                                <i class="fas fa-box-open"></i>
            ...
            `;
                ...
                <div class="content-section">
                    ...
                    <div class="stats-card">
                        <div class="stat">
                            <div class="stat-value">{{ $partners['total_users'] }}</div>
                            <div class="stat-label">Active Partners</div>
                        </div>
                        <div class="stat">
                            <div class="stat-value">{{ $partners['direct_user'] }}</div>
                            <div class="stat-label">Direct</div>
                        </div>
                        <div class="stat">
                            <div class="stat-value">{{ $partners['tier_user'] }}</div>
            ...
            `;
                ...
                <div class="content-section">
                    ...
                    <div class="points-balance">
                        <div class="balance-amount">{{ $partners['gain_point'] + $partners['sponser_point'] }}</div>
                        <div class="balance-label">Available Points</div>
                    </div>
                    <div class="stats-card">
                        <div class="stat">
                            <div class="stat-value">{{ $partners['sponser_point'] }}</div>
                            <div class="stat-label">Tear Points</div>
                        </div>
                          <div class="stat">
                            <div class="stat-value">{{ $partners['gain_point'] }}</div>
                            <div class="stat-label">Self Points</div>
                        </div>
                        <div class="stat">
                            <div class="stat-value">{{ $partners['used_points'] }}</div>
