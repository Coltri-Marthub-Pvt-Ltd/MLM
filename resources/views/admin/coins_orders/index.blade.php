  ...
  height: auto;
    ...
    <div class="fade-in">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            @can('manage_orders')
            {{-- <a href="{{ route('admin.coins-orders.create') }}" class="btn btn-primary">
        ...
        <div class="admin-card mb-4">
            <div class="card-content">
                <form method="GET" action="{{ route('admin.coins-orders.index') }}">
                    <div class="row g-3">
                        <div class="col-md-3">
                                   ...
                                   <td class="fw-medium">{{ \Carbon\Carbon::parse($order->date)->format('M j, Y') }}</td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('admin.coins-orders.show', $order) }}" class="btn btn-sm btn-outline" title="View">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            @can('manage_orders')
                                            {{-- <a href="{{ route('admin.coins-orders.edit', $order) }}" class="btn btn-sm btn-outline" title="Edit">
