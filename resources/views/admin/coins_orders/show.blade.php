    ...
    <div class="fade-in">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                @can('manage_orders')
                    <a href="{{ route('admin.coins-orders.edit', $order) }}" class="btn btn-primary">
                        <i class="bi bi-pencil me-2"></i>
                        Edit Order
                    </a>
                @endcan
                <a href="{{ route('admin.coins-orders.index') }}" class="btn btn-outline">
            ...
            <div class="col-lg-8">
                ...
                <div class="admin-card">
                    ...
                    <div class="card-content">
                        <div class="row">
                            <div class="col-md-6">
                                <form method="POST" action="{{route('admin.coins-orders.status.update')}}">
                                    @csrf
                                    ...
                                    <select name="status" id="" class="form-control">
                                        ...
                                        <option value="2" @if($order->status==2) selected @endif >Approved & Shipped</option>
                ...
                <div class="admin-card">
                    ...
                    <div class="card-content">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <label class="form-label text-muted">coins Rate</label>
                                <div class="fw-medium fs-4 text-success">₹{{ number_format($order->points, 2) }}</div>
                            </div>
                            <div class="col-12">
                                <label class="form-label text-muted">Coins Subtotal</label>
                                <div class="fw-medium fs-4 text-primary">
                                    ₹{{ number_format($order->pints * $order->rate, 2) }}</div>
                            </div>
                            @if ($order->transport)
                                <div class="col-12">
                            ...
                            <div class="col-12">
                                <hr>
                                <label class="form-label text-muted">Total Coins</label>
                                <div class="fw-bold fs-3 text-success">
                                    ₹{{ number_format($order->pints * $order->rate, 2) }}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="admin-card">
                        ...
                        <div class="card-content">
                            <div class="d-grid gap-2">
                                ...
                                <form method="POST" action="{{ route('admin.coins-orders.destroy', $order) }}" class="d-inline">
                                    @csrf
                                    @method('DELETE')
