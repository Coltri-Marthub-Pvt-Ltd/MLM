...
<div class="container-fluid px-3 py-3">
    <div class="row g-3">
        ...
        <div class="col-md-6 col-6">
            <a href="<?php echo e(route('contractor.product.categories','category')); ?>" class="card-link">
                <div class="data-card gradient-1">
                    <div class="card-badge"><?php echo e($category); ?></div>
        ...
        <!-- Application Chart -->
        <div class="col-md-6 col-6">
            <a href="<?php echo e(route('contractor.product.categories','type')); ?>" class="card-link">
                <div class="data-card gradient-2">
                    <div class="card-badge"><?php echo e($appliChart); ?></div>
                    <div class="card-content d-flex flex-column justify-content-between h-100">
        ...
        <!-- Brand Wise -->
        <div class="col-md-6 col-6">
            <a href="<?php echo e(route('contractor.product.categories','brand')); ?>" class="card-link">
                <div class="data-card gradient-3">
                    <div class="card-badge"><?php echo e($brand); ?></div>
                    <div class="card-content d-flex flex-column justify-content-between h-100">
        ...
        <!-- Area Wise -->
        <div class="col-md-6 col-6">
            <a href="<?php echo e(route('contractor.product.categories','area')); ?>" class="card-link">
                <div class="data-card gradient-4">
                    <div class="card-badge"><?php echo e($area); ?></div>
                    <div class="card-content d-flex flex-column justify-content-between h-100">
...
<?php echo $__env->make('layouts.contractor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\MLM\resources\views/contractor/products/tab.blade.php ENDPATH**/ ?>