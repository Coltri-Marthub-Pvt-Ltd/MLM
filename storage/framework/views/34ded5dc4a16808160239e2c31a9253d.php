                    ...
                    <table class="table admin-table" id="badgesTable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $badges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="text-muted">#<?php echo e($badge->id); ?></td>
                                    <td>
                                        <?php if($badge->image): ?>
                                            <img src="<?php echo e(asset($badge->image)); ?>" alt="<?php echo e($badge->name); ?>" class="img-thumbnail" width="50">
                                        <?php else: ?>
                                            <span class="text-muted">No image</span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="fw-medium"><?php echo e($badge->name); ?></td>
                                    <td class="text-primary fw-bold"><?php echo e($badge->coins); ?></td>
                                    <td class="text-muted"><?php echo e($badge->created_at->format('M j, Y')); ?></td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            <button class="btn btn-sm btn-outline-primary edit-badge-btn" 
                                                    ...
                                                    data-coins="<?php echo e($badge->coins); ?>"
                                                    data-image="<?php echo e($badge->image ? asset($badge->image) : ''); ?>"
                                                    title="Edit">
                                                <i class="bi bi-pencil"></i>
                                            </button>
                                            <form method="POST" action="<?php echo e(route('admin.badges.destroy', $badge)); ?>" class="d-inline">
                                                <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="createBadgeModal" tabindex="-1" aria-labelledby="createBadgeModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="createBadgeForm" method="POST" action="<?php echo e(route('admin.badges.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control <?php $__errorArgs = ['coins'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="coins" name="coins" min="0" required>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\MLM\resources\views/admin/badges/index.blade.php ENDPATH**/ ?>