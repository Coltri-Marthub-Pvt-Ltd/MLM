<?php $__env->startSection('title', 'Leader ship Board'); ?>
...
<div class="container-fluid px-3 py-3">
    <div class="row g-3">
        ...
        <div class="col-md-6 col-6">
            <a href="<?php echo e(route('contractor.upcomming.event')); ?>" class="card-link">
        ...
        <!-- Photos of Event -->
        <div class="col-md-6 col-6">
            <a href="<?php echo e(route('contractor.event.gallery')); ?>" class="card-link">
        ...
        <!-- Tier wise -->
        <div class="col-md-6 col-6">
            <a href="<?php echo e(route('contractor.top.wise','tire')); ?>" class="card-link">
        ...
        <!-- Coins wise -->
        <div class="col-md-6 col-6">
            <a href="<?php echo e(route('contractor.top.wise','coin')); ?>" class="card-link">
        ...
        <!-- Top sponsor -->
        <div class="col-md-6 col-6">
            <a href="<?php echo e(route('contractor.top.wise','sponser')); ?>" class="card-link">
        ...
        <!-- Area Wise -->
        <div class="col-md-6 col-6">
            <a href="<?php echo e(route('contractor.top.wise','area')); ?>" class="card-link">
        ...
        <div class="col-md-6 col-6">
            <a href="<?php echo e(route('contractor.top.wise','oldest')); ?>" class="card-link">
...
<?php echo $__env->make('layouts.contractor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\MLM\resources\views/contractor/leader-ship_board.blade.php ENDPATH**/ ?>