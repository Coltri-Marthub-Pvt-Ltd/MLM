...
<div class="orders-container">
            ...
            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="order-card">
                    <div class="order-header">
                        <div>
                            <span class="order-id">Order #<?php echo e($order->order_number); ?></span>
                            <span class="order-date">• <?php echo e($order->created_at?->format('d M Y') ?? 'N/A'); ?></span>
                        </div>
                        <div class="order-status <?php echo e($statusClass); ?>"><?php echo e($statusText); ?></div>
                    </div>

                    <div class="order-row">
                        <img src="<?php echo e($order->product->image_url); ?>" alt="<?php echo e($order->product->name); ?>" class="product-image">
                        <div class="product-details">
                            <div class="product-title"><?php echo e($order->product->name); ?></div>
                            <div class="product-meta">
                                <span class="product-price">₹<?php echo e(number_format($order->rate)); ?></span>
                                <span>•</span>
                                <span>Qty: <?php echo e($order->qty); ?></span>
                            </div>
                        </div>
                        <div class="order-total">
                            ₹<?php echo e(number_format($order->rate * $order->qty)); ?>

                            <div class="points"><?php echo e($order->product->points * $order->qty); ?> points</div>
                        </div>
                        <a href="<?php echo e(route('contractor.orders.track', $order->id)); ?>" class="view-btn" title="View Details">
    ...
    <div id="coins-orders" class="tab-content">
        ...
        <?php else: ?>
            <?php $__currentLoopData = $coinsOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $statusClass = $statusClasses[$order->status] ?? 'status-pending';
                    $statusText = $statusTexts[$order->status] ?? 'Pending';
                ?>
                ...
                <div class="order-card">
                    ...
                    <div class="order-row">
                        ...
                        <div class="order-total">
                            <?php echo e($order->product->points * $order->qty); ?> points
                        </div>
                        <a href="<?php echo e(route('contractor.coins.orders.track', $order->id)); ?>" class="view-btn" title="View Details">
                            <i class="fas fa-eye view-icon"></i>
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.contractor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\MLM\resources\views/contractor/products/myorder.blade.php ENDPATH**/ ?>