                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select <?php $__errorArgs = ['theme_color'];
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            <?php $__currentLoopData = $options['themes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" 
                                                        <?php echo e(old('theme_color', $settings['theme']['theme_color'] ?? 'default') == $key ? 'selected' : ''); ?>>
                                                    <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select <?php $__errorArgs = ['color_mode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            <?php $__currentLoopData = $options['modes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" 
                                                        <?php echo e(old('color_mode', $settings['theme']['color_mode'] ?? 'light') == $key ? 'selected' : ''); ?>>
                                                    <?php echo e($label); ?>

                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <?php $__errorArgs = ['color_mode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="row g-2">
                                        <?php $__currentLoopData = $options['themes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-6 col-md-3">
                                                <div class="theme-preview-card" data-theme="<?php echo e($key); ?>">
                                                    <div class="theme-preview-header theme-<?php echo e($key); ?>"></div>
                                                    <div class="theme-preview-content">
                                                        <div class="theme-preview-sidebar theme-<?php echo e($key); ?>-muted"></div>
                                                        <div class="theme-preview-main">
                                                            <div class="theme-preview-text"></div>
                                                            <div class="theme-preview-text"></div>
                                                        </div>
                                                    </div>
                                                    <div class="theme-preview-label"><?php echo e($label); ?></div>
                                                </div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select <?php $__errorArgs = ['font_family'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                            ...
                                            <?php $__currentLoopData = $options['fonts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($key); ?>" 
                                                        <?php echo e(old('font_family', $settings['theme']['font_family'] ?? 'inter') == $key ? 'selected' : ''); ?>>
                                                    <?php echo e($label); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="sidebar_collapsed" 
                                               ...
                                               <?php echo e(old('sidebar_collapsed', $settings['appearance']['sidebar_collapsed'] ?? false) ? 'checked' : ''); ?>>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="animations_enabled" 
                                               ...
                                               <?php echo e(old('animations_enabled', $settings['appearance']['animations_enabled'] ?? true) ? 'checked' : ''); ?>>
                    ...
                    <div class="card-content">
                        <div class="mb-4">
                            ...
                            <ul class="list-unstyled small">
                                <li><strong>Theme:</strong> <?php echo e($options['themes'][$settings['theme']['theme_color'] ?? 'default'] ?? 'Default Blue'); ?></li>
                                <li><strong>Font:</strong> <?php echo e($options['fonts'][$settings['theme']['font_family'] ?? 'inter'] ?? 'Inter'); ?></li>
                                <li><strong>Mode:</strong> <?php echo e($options['modes'][$settings['theme']['color_mode'] ?? 'light'] ?? 'Light Mode'); ?></li>
                                <li><strong>Sidebar:</strong> <?php echo e(($settings['appearance']['sidebar_collapsed'] ?? false) ? 'Collapsed' : 'Expanded'); ?></li>
                                <li><strong>Animations:</strong> <?php echo e(($settings['appearance']['animations_enabled'] ?? true) ? 'Enabled' : 'Disabled'); ?></li>
                            </ul>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\MLM\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>