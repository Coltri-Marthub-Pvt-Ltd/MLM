...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-lg-none d-flex align-items-center mb-3">
        <a href="<?php echo e(route('contractor.products.index')); ?>" class="text-decoration-none">
            <i class="bi bi-arrow-left" style="font-size: 1.5rem; color: var(--contractor-primary);"></i>
        </a>
        <h5 class="ms-2 mb-0" style="color: var(--contractor-dark);"><?php echo e($product->name); ?></h5>
    </div>
    ...
    <nav aria-label="breadcrumb" class="mb-5 d-none d-lg-block">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="<?php echo e(route('contractor.products.index')); ?>" style="color: var(--contractor-primary);">Products</a>
            </li>
            <?php if($product->category): ?>
                <li class="breadcrumb-item">
                    <a href="<?php echo e(route('contractor.products.index', ['category' => $product->category->id])); ?>"
                        style="color: var(--contractor-primary);"><?php echo e($product->category->name); ?></a>
                </li>
            <?php endif; ?>
        ...
        <div class="col-lg-6">
            ...
            <div class="contractor-card h-100">
                <div class="contractor-card-content p-2 p-lg-3 text-center">
                    <img src="<?php echo e($product->image_url); ?>" alt="<?php echo e($product->name); ?>" class="img-fluid rounded shadow-sm"
                ...
                <div class="contractor-card-content p-3 p-lg-4">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="color: var(--contractor-primary); font-weight: 600; font-size: 0.875rem;">
                                        <?php echo e($product->points ?? 0); ?> points
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="d-flex gap-2 gap-lg-3 mt-3 mt-lg-4 flex-column flex-sm-row">
                        <button class="btn btn-contractor-outline flex-grow-1 py-2" id="orderNowBtn"
                            data-id="<?php echo e($product->id); ?>" style="font-size: 0.875rem;">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('contractor.show.cart')); ?>" class="btn btn-success flex-grow-1 py-2"
                                data-id="<?php echo e($product->id); ?>" style="font-size: 0.875rem;">
                                <i class="bi bi-cart-check me-1"></i>
                                Go to Cart
                            </a>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <?php if($product->category): ?>
                    <a href="<?php echo e(route('contractor.products.index', ['category' => $product->category->id])); ?>"
                        ...
                        View All in <?php echo e($product->category->name); ?>
                ...
                <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="product-card h-100">
                            <a href="<?php echo e(route('contractor.products.show', $relatedProduct)); ?>"
                                ...
                                <div class="h-100 d-flex flex-column">
                                    ...
                                    <div class="product-info p-3">
                                        ...
                                        <h6 class="product-title mb-2"><?php echo e($relatedProduct->name); ?></h6>

                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="product-price fw-bold">
                                                <?php echo e($relatedProduct->formatted_price); ?>

                                            </div>
                                            <div class="product-points text-contractor">
                                                <i class="bi bi-star-fill me-1"></i>
                                                <?php echo e($relatedProduct->points ?? 0); ?> pts
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $('#addToCartBtn').click(function() {
            ...
            let qty = getQty();
            $.ajax({
                url: "<?php echo e(route('contractor.products.cart')); ?>",
                method: 'POST',
                data: {
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        <a href="<?php echo e(route('contractor.show.cart')); ?>" class="btn btn-success flex-grow-1 py-2" data-id="${response.product_id}" style="font-size: 0.875rem;">
                            <i class="bi bi-cart-check me-1"></i>
                            Go to Cart
                        </a>
                    `);
        ...
        $('#orderNowBtn').click(function() {
            ...
            let qty = getQty();
            $.ajax({
                url: "<?php echo e(route('contractor.products.myorder')); ?>",
                method: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    product_id: productId,
        ...
        $('#orderNowBtn').click(function() {
           ...
           $.ajax({
    url: "<?php echo e(route('contractor.products.check-order')); ?>",
    method: 'POST',
    data: {
        _token: '<?php echo e(csrf_token()); ?>',
        product_id: productId
    ...
    error: function(xhr) {
        ...
        function proceedWithOrder(productId, qty, btn) {
            ...
            $.ajax({
                url: "<?php echo e(route('contractor.products.order')); ?>",
                method: 'POST',
                data: {
                    _token: '<?php echo e(csrf_token()); ?>',
                    product_id: productId,
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('contractor.myorders')); ?>";
                        }, 1500);
                    } else {
...
<?php echo $__env->make('layouts.contractor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\MLM\resources\views/contractor/products/show.blade.php ENDPATH**/ ?>