                ...
                <div class="col">
                    <div class="card h-100 border-0 shadow-sm hover-shadow transition-all">
                        <div class="position-relative">
                            <img src="<?php echo e($event->featured_image_url); ?>" class="card-img-top" alt="Event Image">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <span class="text-muted small"><i class="far fa-calendar-alt me-1"></i> <?php echo e(\Carbon\Carbon::parse($event->date)->format('F d, Y')); ?></span>
                                <span class="text-muted small"><i class="fas fa-users me-1"></i> (<?php echo e($diff); ?>)</span>
                            </div>
                            <h5 class="card-title mb-2"><?php echo e($event->title); ?></h5>
                            <p class="card-text text-muted small mb-3 d-none d-sm-block"><?php echo e(\Illuminate\Support\Str::limit($event->description, 69)); ?></p>
...
<?php echo $__env->make('layouts.contractor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\MLM\resources\views/contractor/upcomming_event.blade.php ENDPATH**/ ?>