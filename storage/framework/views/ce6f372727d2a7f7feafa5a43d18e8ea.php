    ...
    <?php if($data->count() > 0): ?>
        <div class="gallery-grid">
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <!-- Featured Image -->
                <?php if($event->featured_image && file_exists(public_path($event->featured_image))): ?>
                    <div class="gallery-item">
                        <div class="card shadow-sm">
                            <img
                                src="<?php echo e(asset($event->featured_image)); ?>"
                                class="card-img-top img-fluid gallery-img"
                                alt="Featured Image - <?php echo e($event->title); ?>"
                                loading="lazy"
                                data-bs-toggle="modal"
                                data-bs-target="#imageModal"
                                data-img-src="<?php echo e(asset($event->featured_image)); ?>"
                            >
                            <div class="card-body text-center p-2">
                                <p class="card-text small mb-0"><?php echo e($event->title); ?> (Featured)</p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <!-- Gallery Images -->
                <?php if(!empty($event->gallery) && is_array($event->gallery)): ?>
                    <?php $__currentLoopData = $event->gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(file_exists(public_path($image))): ?>
                            <div class="gallery-item">
                                <div class="card shadow-sm">
                                    <img
                                        src="<?php echo e(asset($image)); ?>"
                                        class="card-img-top img-fluid gallery-img"
                                        alt="Gallery Image - <?php echo e($event->title); ?>"
                                        loading="lazy"
                                        data-bs-toggle="modal"
                                        data-bs-target="#imageModal"
                                        data-img-src="<?php echo e(asset($image)); ?>"
                                    >
                                    <div class="card-body text-center p-2">
                                        <p class="card-text small mb-0"><?php echo e($event->title); ?></p>
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.contractor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\MLM\resources\views/contractor/event_gallery.blade.php ENDPATH**/ ?>