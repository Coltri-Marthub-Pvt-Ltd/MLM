...
<head>
    ...
    <title>Contractor Login - <?php echo e(config('app.name', 'Laravel')); ?></title>
...
<body>
    <div class="login-container">
        ...
        <div class="login-card">
            ...
            <form method="POST" action="<?php echo e(route('contractor.login')); ?>" id="loginForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center mt-4">
                <p class="login-footer">
                    ...
                    <a href="<?php echo e(route('contractor.register')); ?>" class="register-link">Register here</a>
                </p>
...
</html> <?php /**PATH C:\laragon\www\MLM\resources\views/auth/contractor/login.blade.php ENDPATH**/ ?>