    ...
    <div class="page-content">
        ...
        <div class="leaderboard-container">
            <div class="d-flex align-items-center mb-3 d-md-none">
                <a href="<?php echo e(url()->previous()); ?>" class="back-btn-mobile">
                    <i class="bi bi-arrow-left"></i>
                </a>
                <h5 class="mb-0">Leaderboard</h5>
            </div>

            <?php $__currentLoopData = $leaders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leader): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="badge-filters-scroll">
                        <div class="d-flex flex-nowrap overflow-auto pb-2">
                            ...
                            <?php $__currentLoopData = $badges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button class="badge-filter-btn flex-shrink-0" data-badge="<?php echo e($badge->name); ?>">
                                    <img src="<?php echo e(asset($badge->image)); ?>" width="15" class="me-1">
        ...
        <div class="leaderboard-container">
            <?php $__currentLoopData = $leaders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leader): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="leader-card-mobile" data-badges="<?php echo e($leader['badges']); ?>">
                    <div class="leader-rank-mobile">
                        <?php if($index < 3): ?>
                            <div class="rank-medal-mobile rank-<?php echo e($index + 1); ?>">
                                <i class="bi bi-trophy-fill"></i>
                            </div>
                        <?php else: ?>
                            <div class="rank-number-mobile"><?php echo e($index + 1); ?></div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="leader-main-mobile">
                        ...
                        <div class="leader-info-mobile">
                            <div class="leader-name-mobile"><?php echo e($leader['name']); ?></div>
                            <div class="leader-badges-mobile">
                                <?php $__currentLoopData = explode(',', $leader['badges']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="badge-item-mobile badge-<?php echo e(trim($badge)); ?>">
                                        <i class="bi bi-award me-1"></i>
                                        <?php echo e(ucfirst(trim($badge))); ?>
                    ...
                    <div class="leader-stats-mobile">
                        <div class="stat-item-mobile">
                            <div class="stat-value-mobile"><?php echo e($leader['points']); ?></div>
                            <div class="stat-label-mobile">Points</div>
                        </div>
                        <div class="stat-item-mobile">
                            <div class="stat-value-mobile"><?php echo e($leader['sponsors']); ?></div>
                            <div class="stat-label-mobile">Sponsors</div>
                        </div>
                        <div class="stat-item-mobile">
                            <div class="stat-value-mobile"><?php echo e($leader['orders']); ?></div>
...
<?php echo $__env->make('layouts.contractor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\MLM\resources\views/contractor/leaders.blade.php ENDPATH**/ ?>