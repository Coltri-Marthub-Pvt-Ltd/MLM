...
<body class="admin-body" <?php echo \App\Models\Setting::getThemeAttributesString(); ?>>
    <!-- Sidebar -->
    <nav class="admin-sidebar" id="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <?php if(auth()->user()->can('view_categories') || auth()->user()->can('view_products')): ?>
            <div class="nav-section">
                ...
                <?php endif; ?>
                 ...
                 <div class="nav-item">
                    <a href="<?php echo e(route('admin.product-types.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.product-types.*') ? 'active' : ''); ?>">
                        <i class="bi bi-tags nav-icon"></i>
                        Product Types
                    </a>
                </div>
                ...
                <div class="nav-item">
                    <a href="<?php echo e(route('admin.coins-products.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.coins-products.*') ? 'active' : ''); ?>">
                        <i class="bi bi-box nav-icon"></i>
                        Coins Products
                    </a>
                </div>
                <div class="nav-item">
                    <a href="<?php echo e(route('admin.gitcards.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.gitcards.*') ? 'active' : ''); ?>">
                        <i class="bi bi-box nav-icon"></i>
                        Gitcards
                    </a>
                </div>
                <div class="nav-item">
                    <a href="<?php echo e(route('admin.limited-schemes.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.limited-schemes.*') ? 'active' : ''); ?>">
                        <i class="bi bi-box nav-icon"></i>
                        Limited Schemes
                    </a>
                </div>
                   <div class="nav-item">
                    <a href="<?php echo e(route('admin.deals.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.deals.*') ? 'active' : ''); ?>">
                        <i class="bi bi-box nav-icon"></i>
                        Deals
                    </a>
                </div>
                <?php endif; ?>
                   <div class="nav-item">
                    <a href="<?php echo e(route('admin.new-schemes.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.new-schemes.*') ? 'active' : ''); ?>">
                        <i class="bi bi-box nav-icon"></i>
                        New Schemes
                    </a>
                </div>
                 <div class="nav-item">
                    <a href="<?php echo e(route('admin.new-opportunities.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.new-opportunities.*') ? 'active' : ''); ?>">
                        <i class="bi bi-box nav-icon"></i>
                        New Opportunities
                    </a>
                </div>
            ...
            <div class="nav-section">
                ...
                <div class="nav-item">
                    <a href="<?php echo e(route('admin.coins-orders.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.coins-orders.*') ? 'active' : ''); ?>">
                        <i class="bi bi-receipt nav-icon"></i>
                       Coins Orders
                    </a>
                </div>
            ...
            <div class="nav-section">
                ...
                <div class="nav-item">
                    <a href="<?php echo e(route('admin.monthly-targets.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.monthly-targets.*') ? 'active' : ''); ?>">
                        <i class="bi bi-list-task nav-icon"></i>
                        Monthly Targets
                    </a>
                </div>
                ...
                <div class="nav-item">
                    <a href="<?php echo e(route('admin.enquery')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.enquery') ? 'active' : ''); ?>">
                        <i class="bi bi-list-task nav-icon"></i>
                        Enquery
                    </a>
                </div>
            ...
            <?php endif; ?>
              <div class="nav-section">
                ...
                <div class="nav-item">
                 ...
                 <div class="nav-item">
                    <a href="<?php echo e(route('admin.sampling-requests.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.sampling-requests.*') ? 'active' : ''); ?>">
                        <i class="bi bi-list-task nav-icon"></i>
                        Sampling Requests
                    </a>
                </div>
                   <div class="nav-item">
                    <a href="<?php echo e(route('admin.complaints.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.complaints.*') ? 'active' : ''); ?>">
                        <i class="bi bi-list-task nav-icon"></i>
                        Complaints
                    </a>
                </div>
                 <div class="nav-item">
                    <a href="<?php echo e(route('admin.visit-requests.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.visit-requests.*') ? 'active' : ''); ?>">
                        <i class="bi bi-list-task nav-icon"></i>
                       Visit Requests
                    </a>
                </div>
                <div class="nav-item">
                    <a href="<?php echo e(route('admin.git-distributeds.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.git-distributeds.*') ? 'active' : ''); ?>">
                        <i class="bi bi-list-task nav-icon"></i>
                       Photos
                    </a>
                </div>
            ...
            <?php if(auth()->user()->can('view_users') || auth()->user()->can('view_roles') || auth()->user()->can('view_permissions') || auth()->user()->can('manage_contractors')): ?>
            <div class="nav-section">
                <div class="nav-section-title">User Management</div>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_users')): ?>
                    <div class="nav-item">
                    <a href="<?php echo e(route('admin.badges.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.badges.*') ? 'active' : ''); ?>">
                ...
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage_contractors')): ?>
                <div class="nav-item">
                    <a href="<?php echo e(route('admin.contractors.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.contractors.*') ? 'active' : ''); ?>">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-outline dropdown-toggle" type="button" data-bs-toggle="dropdown">
                            ...
                            <?php if(Auth::user()->roles->count() > 0): ?>
                                <span class="badge badge-primary ms-2"><?php echo e(Auth::user()->roles->first()->name); ?></span>
                            <?php endif; ?>
                        </button>
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-header">
                                ...
                                <?php $__currentLoopData = Auth::user()->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <br><span class="badge badge-secondary badge-sm"><?php echo e($role->name); ?></span>
...
</html> <?php /**PATH C:\laragon\www\MLM\resources\views/layouts/admin.blade.php ENDPATH**/ ?>